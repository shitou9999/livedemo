package com.iguxuan.iguxuan_friends.live.adapter;
...
import com.iguxuan.iguxuan_friends.live.model.Message;
import com.iguxuan.iguxuan_friends.util.ImageDisplayUtils;
import com.iguxuan.iguxuan_friends.widget.PostParentLayout;
 ...
 */
public class ReadingTapeAdapter extends RecyclerView.Adapter<ReadingTapeAdapter.ViewHolder> {
    ...
    public ReadingTapeAdapter(Activity context, List<Message> messages) {
        mContext = context;
        mMessages = messages;
    }
