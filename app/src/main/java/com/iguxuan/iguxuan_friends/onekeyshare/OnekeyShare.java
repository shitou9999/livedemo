...
package com.iguxuan.iguxuan_friends.onekeyshare;
...
public class OnekeyShare {
    ...
    public void show(Context context) {
        ...
        //themeImpl.setPlatformActionListener(new ShareUtils.OneKeyShareCallback(context, "dccsdfs"));
