...
public class KnifeText extends EditText implements TextWatcher {
    ...
    private void init(AttributeSet attrs) {
        ...
        linkColor = array.getColor(R.styleable.KnifeText_linkColor, Color.BLUE);
        linkUnderline = array.getBoolean(R.styleable.KnifeText_linkUnderline, true);
        quoteColor = array.getColor(R.styleable.KnifeText_quoteColor, Color.parseColor("#cccccc"));
        quoteStripeWidth = array.getDimensionPixelSize(R.styleable.KnifeText_quoteStripeWidth, 0);
        quoteGapWidth = array.getDimensionPixelSize(R.styleable.KnifeText_quoteCapWidth, 5);
        array.recycle();
...
//            case FORMAT_COLOR:
//                return containColor(getSelectionStart(), getSelectionEnd());
            default:
                return false;
        }
    }
