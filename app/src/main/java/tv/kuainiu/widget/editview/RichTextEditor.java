...
public class RichTextEditor extends InterceptLinearLayout {
    ...
    private void init() {
        ...
        KnifeText firstEdit = createEditText("", dip2px(EDIT_FIRST_PADDING_TOP));
     ...
     */
    private void onBackspacePress(KnifeText editTxt) {
        ...
        if (startSelection == 0) {
            ...
            if (null != preView) {
                if (preView instanceof RelativeLayout) {
                    ...
                    CharSequence str1 = editTxt.getText();
                    KnifeText preEdit = (KnifeText) preView;
                    CharSequence str2 = preEdit.getText();
...
//                    preEdit.append(str2);
    ...
    private KnifeText createEditText(String hint, int paddingTop) {
        KnifeText editText = (KnifeText) inflater.inflate(
...
//        }, 200);
    ...
    private void mergeEditText() {
        ...
        if (preView != null && preView instanceof KnifeText && null != nextView
                && nextView instanceof KnifeText) {
            KnifeText preEdit = (KnifeText) preView;
            KnifeText nextEdit = (KnifeText) nextView;
