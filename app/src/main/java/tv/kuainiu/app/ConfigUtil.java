...
public class ConfigUtil {
	...
	// 配置API KEY
	public final static String API_KEY = "EmRmV8CdSeFlKJcLQC5zNnRIWmfMKlgE";

	// 配置帐户ID
	public final static String USERID = "5CBAF26702FFB57E";

	// 配置下载文件路径
	public final static String DOWNLOAD_DIR = "kuainiuTv";
