 ...
 * 收藏
 */
public class AppointmentFragmentAdapter extends BaseSwipeAdapter {
    private Context context;
    private List<Appointment> listCollect;
    private IdeletItem idelectItem;

    public AppointmentFragmentAdapter(Context context, List<Appointment> listCollect, IdeletItem idelectItem) {
